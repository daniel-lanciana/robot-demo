...
Running demo at: https://floating-cove-6107.herokuapp.com (please note the demo is not thread-safe by design i.e. all users control the same robot!)
...
* Test wording? should...
* View-layer tests? (table size...) Functional tests http://guides.rubyonrails.org/testing.html
