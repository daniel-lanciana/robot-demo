...
* Table knows about robots for extensibility (add more robots)
...
* Create a 'Chaos Robot' button that launches a JavaScript thread that randomly moves a robot around
* Add multiple robots = Chaos monkey controlling robots (threads) + whenever change update view
* Push to Heroku
